...
import (
	...
	routeTester "github.com/MicroFish91/portfolio-instruments-api/tests/integration/routetester/holding"
	"github.com/MicroFish91/portfolio-instruments-api/tests/integration/testcases"
	"github.com/MicroFish91/portfolio-instruments-api/tests/utils"
	"github.com/gofiber/fiber/v3"
)

func GetHoldingsTestCases(t *testing.T, userId int, email string) []testcases.TestCase {
	...
	return []testcases.TestCase{
		// ---- 200 ----
		{
			...
			ExpectedResponse: routeTester.GetHoldingsExpectedResponse{
				Holdings: 30,
